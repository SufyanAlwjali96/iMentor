 ...
 */
public class TAB6 extends Fragment implements SearchView.OnQueryTextListener{
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater)
    {
        ...
        mTracker.send(new HitBuilders.EventBuilder()
                .setCategory("فئة اعدادي")
                .setAction("البحث عن مدرس اعدادي")
                .build());
    }
    ...
    public void onResume() {
        super.onResume();
        mTracker.setScreenName("معلمين اعدادي");
