 ...
 */
public class TAB7 extends Fragment implements SearchView.OnQueryTextListener{
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater)
    {
        ...
        mTracker.send(new HitBuilders.EventBuilder()
                .setCategory("فئة ثانوي")
                .setAction("البحث عن مدرس ثانوي")
                .build());
    }
    ...
    public void onResume() {
        super.onResume();
        mTracker.setScreenName("معلمين ثانوي");
