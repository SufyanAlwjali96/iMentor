...
public class CenterProfile extends AppCompatActivity {
    ...
    private void initializeData() {
        ...
        final Center saved_center = realm
                .where(Center.class)
                .equalTo("id", center_id)
                .findFirst();
        realm.commitTransaction();
        toolbar = findViewById(R.id.ctoolbar);

        toolbar.setTitle(saved_center.getName());
        TextView textView = (TextView) toolbar.getChildAt(0);
        textView.setTypeface(typeface);
        textView.setTextSize(16.0f);
        textView.setTextColor(getResources().getColor(android.R.color.white));
        setSupportActionBar(toolbar);
        details.setText(saved_center.getDetails());
        name.setText(saved_center.getName());

        address.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
/*
                Dialog dialog = new Dialog(CenterProfile.this);
                ...
                textView2.setText(saved_center.getName());
                textView.setText(saved_center.getAddress());
                dialog.show();
                */

                new PromptDialog(CenterProfile.this)
                        .setDialogType(PromptDialog.DIALOG_TYPE_SUCCESS)
                        .setAnimationEnable(true)
                        .setTitleText(saved_center.getName())
                        .setContentText(saved_center.getAddress())
                        .show();
        ...
        phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /*
                String mobileNo = saved_center.getPhone();
                String uri = "tel:" + mobileNo.trim();
                Intent intent = new Intent(Intent.ACTION_CALL);
                intent.setData(Uri.parse(uri));
                if (ActivityCompat.checkSelfPermission(CenterProfile.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                ...
                */
                ...
                phone.setText(saved_center.getPhone());
                phone.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        String mobileNo = saved_center.getPhone();
                ...
                phone2.setText(saved_center.getPhone2());
                phone2.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        String mobileNo = saved_center.getPhone2();
                        String uri = "tel:" + mobileNo.trim();
                        Intent intent = new Intent(Intent.ACTION_CALL);
                        intent.setData(Uri.parse(uri));
                        if (ActivityCompat.checkSelfPermission(CenterProfile.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
        ...
        map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Double lat = saved_center.getLatitude();
                final Double lng = saved_center.getLongitude();
                Dialog dialog = new Dialog(CenterProfile.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
                ...
                MapsInitializer.initialize(CenterProfile.this);
                ...
                mMapView.getMapAsync(new OnMapReadyCallback() {
                    ...
                    public void onMapReady(final GoogleMap googleMap) {
                        ...
                        googleMap.addMarker(new MarkerOptions().position(posisiabsen).title(saved_center.getName())).showInfoWindow();
