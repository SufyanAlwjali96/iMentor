...
public class UniversityProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        university_id = getIntent().getIntExtra("university_id", 0);
    ...
    private void initializeData() {
        ...
        final University saved_university = realm
                .where(University.class)
                .equalTo("id", university_id)
                .findFirst();
        realm.commitTransaction();

        details.setText(saved_university.getDetails());
        toolbar = findViewById(R.id.utoolbar);

        toolbar.setTitle(saved_university.getName());
        ...
        details.setText(saved_university.getDetails());
        name.setText(saved_university.getName());

        address.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new PromptDialog(UniversityProfile.this)
                        .setDialogType(PromptDialog.DIALOG_TYPE_SUCCESS)
                        .setAnimationEnable(true)
                        .setTitleText(saved_university.getName())
                        .setContentText(saved_university.getAddress())
                        .show();
            }
        });
        ...
        phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                */
                Dialog dialog = new Dialog(UniversityProfile.this);
                ...
                phone.setText(saved_university.getPhone());
                phone.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        String mobileNo = saved_university.getPhone();
                ...
                phone2.setText(saved_university.getPhone2());
                phone2.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        String mobileNo = saved_university.getPhone2();
                        String uri = "tel:" + mobileNo.trim();
                        Intent intent = new Intent(Intent.ACTION_CALL);
                        intent.setData(Uri.parse(uri));
                        if (ActivityCompat.checkSelfPermission(UniversityProfile.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
        ...
        map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Double lat = saved_university.getLatitude();
                final Double lng = saved_university.getLongitude();
                Dialog dialog = new Dialog(UniversityProfile.this, android.R.style.Theme_Black_NoTitleBar_Fullscreen);
                ...
                MapsInitializer.initialize(UniversityProfile.this);
                ...
                mMapView.getMapAsync(new OnMapReadyCallback() {
                    ...
                    public void onMapReady(final GoogleMap googleMap) {
                        ...
                        googleMap.addMarker(new MarkerOptions().position(posisiabsen).title(saved_university.getName())).showInfoWindow();
